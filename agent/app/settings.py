...
class Settings:
    ...
    host_proc: str = os.getenv("NAS_AGENT_HOST_PROC", "/host/proc")
    host_sys: str = os.getenv("NAS_AGENT_HOST_SYS", "/host/sys")
    host_etc: str = os.getenv("NAS_AGENT_HOST_ETC", "/host/etc")
